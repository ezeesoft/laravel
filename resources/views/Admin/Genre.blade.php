                   ...
                   ADD NEW GENRE
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-header">
                            <h1 class="modal-title fs-5" id="exampleModalLabel">Add New Genre</h1>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                       
                        <form method="post" action="{{url('GenrePost')}}">@csrf
                    ...
                    <div class="card mt-5">
                                        <h1 style="text-align: center;">GENRE RECORDS </h1>
                    <table border=2  class="table table-bordered">
                        ...
                        <td>{{$data->id}}</td>
                    <td>{{$data->name}}</td>
                    <td><a href="{{url('/contacts/delete/')}}/{{$data->id}}"><button class="btn btn-danger">Delete</button></a></td>
                    ...
                    <div class="modal-dialog">
                        ...
                        <form method="post" action="{{ url('GenreEdit/'.$data->id)}}}}">@csrf
